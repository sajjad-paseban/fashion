...
var up_arrow = document.getElementsByClassName('up-arrow')[0];
...
window.onscroll = function () {
  if (window.scrollY > 80) document.getElementsByClassName('header-top')[0].classList.add('fixed');else document.getElementsByClassName('header-top')[0].classList.remove('fixed');
};
...
var mobile_menu_wrapper = document.getElementsByClassName('header-top-menu-mobile-wrapper')[0];
var header_top = document.getElementsByClassName('header-top')[0];
$('.header-top-menu-mobile-wrapper > ul > li:not(#train-list-item) a').on('click', function () {
  mobile_menu_wrapper.classList.remove('show-menu');
});
mobile_menu_wrapper.addEventListener('click', function (e) {
  e.stopPropagation();
});
...
$('#train-list-item > a').on('click', function () {
...
/******/ 	__webpack_require__("./resources/js/functions.js");
